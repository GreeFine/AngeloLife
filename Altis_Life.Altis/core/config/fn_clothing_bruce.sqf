...
//Shop Title Name
ctrlSetText[3103,"Magasin de vetements"];
...
switch (_filter) do
{
	...
	case 0:
	{
		...
		["U_IG_Guerilla2_3","Chemise bleu",1200],
		["U_C_HunterBody_grn","Chasse",1500],
		["U_C_WorkerCoveralls","Mécano",2500],
		["U_OrestesBody","Surfeur",1100],
		["U_NikosAgedBody","31",1500],
		["U_NikosBody","Décontracté",1100],
		["U_Marshal","Habillé",1100],
		["U_C_Journalist","Journaliste",2500],
